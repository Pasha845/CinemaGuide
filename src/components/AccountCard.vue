<template>
  <router-link class="account__item item" to="">
    ...
    <img :src="fav.posterUrl" :alt="fav.title" width="224" height="336">
  </router-link>
</template>

<script setup lang="ts">
  import { GetFavorites, useAuthStore } from '@/stores/auth';

  const newFav = defineProps<{ fav: GetFavorites }>();
