<template>
  <transition>
    <div class="modal" v-if="isTrailerModalOpen">
      <div class="modal-trailer">
        ...
        <iframe class="modal-video" :src="'https://www.youtube.com/embed/' + movie.trailerUrl.split('=')[1] + '?autoplay=1&enablejsapi=1&showinfo=0&controls=0&modestbranding=1&fs=0&rel=0'" allow='autoplay' frameborder="0" allowfullscreen></iframe>
